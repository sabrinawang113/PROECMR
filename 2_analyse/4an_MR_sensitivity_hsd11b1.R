...
## file paths ====
OUTPUT = "C:/Users/wangs/OneDrive - IARC/Projects_IARC/Proj_PROECMR/2_derivedata/mr_hsd11b1/"

## data_exposure ====
data_exposure_all <- read.table("C:/Users/wangs/OneDrive - IARC/Projects_IARC/Proj_PROECMR/1_initialdata/UKBPPP_Sun/HSD11B1_P28845_OID20575", sep = "", header = TRUE)
...
write.table(data_clumped, paste0(OUTPUT, "data_clump.txt"),
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
data_sensitivity <- mr_singlesnp(data_harmonise, method)
