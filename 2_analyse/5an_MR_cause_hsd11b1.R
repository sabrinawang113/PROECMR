...
# data ====
data_exposure <- read.table("C:/Users/wangs/OneDrive - IARC/Projects_IARC/Proj_PROECMR/1_initialdata/UKBPPP_Sun/HSD11B1_P28845_OID20575", sep = "", header = TRUE)
...
#data_exposure$pval <-  c(10^(-1*as.numeric(data_exposure$LOG10P)))
...
# save ====
save(X, params, data_clump, top_vars, file = "C:/Users/wangs/OneDrive - IARC/Projects_IARC/Proj_PROECMR/2_derivedata/mrcause_HSD11B1_P28845_OID20575_combined.RData")
